...
import com.multi.todolist.common.wrapper.EncryptRequestWrapper;

/* user 서비스인 경우에만 암호화 처리 할 수 있도록 한다. */
@WebFilter("/user/*")
public class PasswordEncryptFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		/*
		 * 로그인을 하는 경우 자동 암호화된 값으로 비교하게 되면 비교할 수 없다. 로그인 요청은 암호화하는 필터에서 암호화 처리 되지 않도록
		 * 해준다.
		 */
