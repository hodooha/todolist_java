...
<style>
	...
	.nav-area{background:purple;height:50px;color:white;}
	.menu{
		display:table-cell;
		width:250px;
		height:50px;
...
<body>
				...
				<table align="center">
					...
					<tr>
						...
						<!-- https://join.shopping.naver.com/intro/effect.nhn 이렇게 확장자 쓰기도함. 하단 네이버 비지니스 -->
							...
							<a href="${ pageContext.servletContext.contextPath}/user/insert"  >회원가입 </a> 
							<a href="" > 아이디/비번 찾기 </a>
						</td>
					</tr>
				</table>
			...
			<table align="right">
				<tr>
					<td colspan="2">
						...
						<button class="btns" onclick="location.href='${ pageContext.servletContext.contextPath}/user/logout';">로그아웃</button>
					</td>
				</tr>
			</table>
		</c:if>
	...
	<div class="nav-area" align="center">
		...
		<div class="menu" onclick="location.href='${pageContext.servletContext.contextPath }/user';">내정보</div>
		<div class="menu" onclick="location.href='${pageContext.servletContext.contextPath }/task';">일정</div>
		<div class="menu" onclick="location.href='${pageContext.servletContext.contextPath }/diary';">일기장</div>
	</div>
</body>
</html>